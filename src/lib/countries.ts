...
export const COUNTRIES: CountryOption[] = [
  ...
  { name: 'American Samoa', callingCode: '+1-684' },
  { name: 'Andorra', callingCode: '+376' },
  { name: 'Angola', callingCode: '+244' },
  { name: 'Anguilla', callingCode: '+1-264' },
  { name: 'Antigua and Barbuda', callingCode: '+1-268' },
  ...
  { name: 'British Virgin Islands', callingCode: '+1-284' },
  ...
  { name: 'Cayman Islands', callingCode: '+1-345' },
  ...
  { name: 'Dominica', callingCode: '+1-767' },
  { name: 'Dominican Republic', callingCode: '+1-809' },
  ...
  { name: 'Grenada', callingCode: '+1-473' },
  { name: 'Guadeloupe', callingCode: '+590' },
  { name: 'Guam', callingCode: '+1-671' },
  { name: 'Guatemala', callingCode: '+502' },
  { name: 'Guernsey', callingCode: '+44-1481' },
  ...
  { name: 'Montserrat', callingCode: '+1-664' },
  ...
  { name: 'Northern Mariana Islands', callingCode: '+1-670' },
  ...
  { name: 'Puerto Rico', callingCode: '+1-787' },
  ...
  { name: 'Saint Kitts and Nevis', callingCode: '+1-869' },
  { name: 'Saint Lucia', callingCode: '+1-758' },
  { name: 'Saint Martin', callingCode: '+590' },
  { name: 'Saint Pierre and Miquelon', callingCode: '+508' },
  { name: 'Saint Vincent and the Grenadines', callingCode: '+1-784' },
  ...
  { name: 'Sint Maarten', callingCode: '+1-721' },
  ...
  { name: 'Trinidad and Tobago', callingCode: '+1-868' },
  { name: 'Tunisia', callingCode: '+216' },
  { name: 'Turkey', callingCode: '+90' },
  { name: 'Turkmenistan', callingCode: '+993' },
  { name: 'Turks and Caicos Islands', callingCode: '+1-649' },
  ...
  { name: 'Vatican City', callingCode: '+39-06' },
  { name: 'Venezuela', callingCode: '+58' },
  { name: 'Vietnam', callingCode: '+84' },
  { name: 'Virgin Islands', callingCode: '+1-340' },
...
export const CALLING_CODES: CallingCodeOption[] = Array.from(
  COUNTRIES.reduce((codes, country) => {
    const countries = codes.get(country.callingCode) ?? [];
    countries.push(country.name);
    codes.set(country.callingCode, countries);
    return codes;
  }, new Map<string, string[]>())
).map(([code, countries]) => ({
  code,
  label: countries.length > 1 ? `${code} ${countries.join(' / ')}` : `${code} ${countries[0]}`,
}));
