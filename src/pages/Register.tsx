              ...
              <SignedOut>
                <div className="flex flex-col gap-2">
                  <SignInButton mode="modal">
                    <Button className="w-full h-12 rounded-full bg-[#A35233] hover:bg-[#8b4328] text-white">
                      Sign In
                    </Button>
                  </SignInButton>
                  <SignUpButton mode="modal">
                    <Button variant="outline" className="w-full h-12 rounded-full border-[#A35233] text-[#A35233]">
                      Sign Up
                    </Button>
                  </SignUpButton>
                </div>
