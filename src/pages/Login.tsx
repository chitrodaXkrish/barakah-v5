...
const AppleLogoMark = () => (
  <svg viewBox="0 0 24 24" className="w-[50px] h-[50px] mx-3" aria-hidden="true">
    <path
      fill="currentColor"
      ...
      <div className="relative z-10 w-full px-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Button 
              variant="outline" 
              className="w-full rounded-xl h-16 bg-white/90 border-sage/30 hover:bg-white text-sage font-medium"
            >
            ...
            <Button 
              variant="outline" 
              className="w-full rounded-xl h-16 bg-white/90 border-sage/30 hover:bg-white text-sage font-medium flex items-center justify-center"
            >
              <AppleLogoMark />
              {t('login.apple')}
            </Button>
